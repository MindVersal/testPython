...
class StickFigureSprite(Sprite):
    ...
    def coords(self):
        ...
        self.coordinates.x2 = xy[0] + 35
        self.coordinates.y2 = xy[1] + 45
        return self.coordinates
...
platform9 = PlatformSprite(g, PhotoImage(file="./img/Platform1.gif"), 170, 250, 32, 10)
platform10 = PlatformSprite(g, PhotoImage(file="./img/Platform1.gif"), 230, 200, 32, 10)
